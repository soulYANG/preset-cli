...
<script>
import headerCell from '@/components/labelCell/header'
import overviewCell from '@/components/labelCell/overview'
import contentCell from '@/components/labelCell/content'
import footerCell from '@/components/labelCell/footer'
  ...
  mounted() {
    this.$nextTick(() => {
      ...
      for (var i = 0; i <= stars; i++) {
        ...
        tpl += '<span style=" width: ' + size + 'px; height: ' + size + 'px; top: ' + Math.random()*100 + '%; left: ' + Math.random()*100 + '%; background: ' + color + '; box-shadow: 0 0 '+ Math.random()*10 +'px' + color + ';"></span>';
      }
