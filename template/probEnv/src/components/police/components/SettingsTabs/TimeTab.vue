...
export default {
  ...
  created() {
    queryTime(this.pagination).then((res) => {
  ...
  methods: {
    editMethods() {
      ...
      updateTime(this.editData).then((res) => {
    ...
    handleSwitchChange(item) {
      updateTimeEnable(item).then((res) => {
    ...
    saveTime() {
      ...
      saveTime(this.postData).then((res) => {
